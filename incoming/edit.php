...
<form method="post" class="card">
    ...
    <div class="form-grid">
        ...
        <div><label>نیټه (د ثبت) <span style="color:red;">*</span></label><input type="text" name="incoming_date" required value="<?= e($f['incoming_date']) ?>"></div>
        <div><label>نیټه (د مکتوب) <span style="color:red;">*</span></label><input type="text" name="letter_date" required value="<?= e($f['letter_date']) ?>"></div>
